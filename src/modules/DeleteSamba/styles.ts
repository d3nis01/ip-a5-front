...
export const SambaDeleteContainer = styled.div`
  width: 100%;
...
export const SambaDeleteInnerContainer = styled.div`
...
export const DeleteSambaTitle = styled.h1`
...
export const SambaDeleteResponseWrapper = styled.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
  padding-left: 12px;
...
export const SambaDeleteResponseItem = styled.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
`;

export const SambaDeleteResponseBox = styled.div`
  display: flex;
  align-items: center;
